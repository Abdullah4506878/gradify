...
export default function AddStudentPage() {
  ...
  const handleSubmit = async () => {
    if (!rollNumber.trim() || !email.trim()) {
      setError('Roll Number and Email are required.');
      return;
    }
    setError(null);
    setLoading(true);
    try {
      ...
      setError(typeof msg === 'string' ? msg : 'Failed to add student. Please try again.');
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <DashboardLayout navItems={navItems}>
      ...
      <div className="mb-6">
        ...
        <p className="mt-1 text-sm text-gray-500">Register a new student account</p>
      </div>
      ...
      <div className="max-w-lg space-y-5">
        ...
        {success && (
          <div className="rounded-xl border border-green-200 bg-green-50 px-5 py-4">
            <p className="text-sm font-semibold text-green-800 mb-2">Student added successfully!</p>
            ...
            <CardContent className="pt-6 space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="e.g. SP21-BSE-001"
                  className="w-full rounded-lg border border-gray-200 bg-gray-50 px-3.5 py-2.5 text-sm text-gray-900 placeholder-gray-400 focus:border-indigo-500 focus:bg-white focus:outline-none focus:ring-2 focus:ring-indigo-500/20 transition-colors"
                />
                <p className="mt-1 text-xs text-gray-400">Stored as the student's identifier in the system.</p>
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="e.g. sp21-bse-001@superior.edu.pk"
                  className="w-full rounded-lg border border-gray-200 bg-gray-50 px-3.5 py-2.5 text-sm text-gray-900 placeholder-gray-400 focus:border-indigo-500 focus:bg-white focus:outline-none focus:ring-2 focus:ring-indigo-500/20 transition-colors"
                />
              </div>
              ...
              <div>
                ...
                <p className="mt-1 text-xs text-gray-400">Auto-generated. Share this with the student after creation.</p>
              </div>
